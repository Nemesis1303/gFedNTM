...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scripts for DSS-TSS Experiments")
    parser.add_argument("--path_results",
                        type=str,
                        default="/export/usuarios_ml4ds/lbartolome/Repos/my_repos/gFedNTM/experiments/dss_tss/results/eta_variable",
                        required=False, metavar=("path_results"),
                        help="Path to folder where the results will be saved")
    parser.add_argument("--path_config",
                        type=str,
                        default="/export/usuarios_ml4ds/lbartolome/Repos/my_repos/gFedNTM/experiments/dss_tss/config/eta_variable",
                        required=False, metavar=("path_results"),
                        help="Path to folder where the results will be saved")
...
# eta_variable
# ----------------
## --path_results /export/usuarios_ml4ds/lbartolome/Repos/my_repos/gFedNTM/experiments/dss_tss/results/eta_variable --path_config /export/usuarios_ml4ds/lbartolome/Repos/my_repos/gFedNTM/experiments/dss_tss/config/eta_variable

# ----------------
# frozen_variable
# ----------------
## --path_results /export/usuarios_ml4ds/lbartolome/Repos/my_repos/gFedNTM/experiments/dss_tss/results/frozen_variable --path_config /export/usuarios_ml4ds/lbartolome/Repos/my_repos/gFedNTM/experiments/dss_tss/config/frozen_variable